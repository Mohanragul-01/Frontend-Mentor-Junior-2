...
const yourCartItemsContainer = document.querySelector(".your-cart-items-container");
...
const yourCartContainerFull = document.querySelector(".your-cart-container-full");
const yourCartContainerEmpty = document.querySelector(".your-cart-container-empty");

const totalBill = document.querySelector(".total-bill");
const confirmedCartItemContainer = document.querySelector(".confirmed-cart-item-container");
...
const removeItemFromCart = (id) => {
  ...
  if (cart.length === 0) {
    document.querySelector(".your-cart-container-empty").style.display = "block";
